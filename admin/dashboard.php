...
<div class="mb-5 rounded-lg border px-4 py-3.5 flex gap-3 items-start" style="background:#fffbeb; border-color:#fde68a">
  ...
  <div class="min-w-0 flex-1">
    ...
    <p class="text-sm mt-1 leading-6" style="color:#92400e">Akun admin masih memakai <code>aliali123</code>. Segera ganti password melalui database agar keamanan terjaga.</p>
  </div>
</div>
<?php endif; ?>
